    ...
    <div class="field-box">
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab==='field' && showField" size="small" label-width="90px">
          ...
          <el-form-item v-if="activeData.__vModel__!==undefined" label="字段名" style="font-weight: bold">
            <el-input v-model="activeData.__vModel__" placeholder="请输入字段名（v-model）" />
          </el-form-item>
          <el-form-item v-if="activeData.maxlength !== undefined" label="最多输入" style="font-weight: bold">
        ...
        <el-form v-show="currentTab === 'form'" size="small" label-width="90px">
          <el-form-item label="表单名">
            <el-input v-model="formConf.formRef" placeholder="请输入表单名（表名小写，_分割）" />
          </el-form-item>
...
export default {
  ...
  watch: {
    formConf: {
      handler(val) {
        // 表名不允许输入大写字母
        val.formRef = val.formRef.toLowerCase();
        saveFormConf(val)
      },
      deep: true
    }
