      ...
      <div style="height:100%;padding: 5px 20px">
        <el-row style="margin-top: 5px">
          <el-form r :rules="rules"
                   :model="projInfo" label-width="90px"
                   style="width: 100%;"
            ...
            <el-row :gutter="5" >
              ...
              <el-col :span="4">
                <el-form-item label="组织：" prop="companyName">
                  <el-input v-model="projInfo.companyName"  placeholder="域.公司（例:com.tansun）"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="4">
                <el-form-item label="项目|产品" prop="productName">
                  <el-input v-model="projInfo.productName"  placeholder="例：credit"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="4">
                <el-form-item label="模块名：" prop="moduleName">
                  <el-input v-model="projInfo.moduleName" placeholder="例：lowcode"></el-input>
<!--                  <el-autocomplete
                    v-model="projInfo.moduleName"
            ...
            <el-row :gutter="5" style="margin-top: 5px">
              ...
              <el-col :span="8">
                <el-form-item  label="描述：" prop="description">
                  <el-input v-model="projInfo.description" placeholder="可选项" ></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="4">
              ...
              <el-col :span="8" align="right">
                ...
                <el-button type="primary" @click="installCode">下载zip包</el-button>
              </el-col>
            </el-row>
          </el-form>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    previewBackendCode() {
      ...
      let sql = editorObj.pgsql.getValue();
      // 执行sql，生成表
      request({
    ...
    installCode() {
      ...
      this.$refs['groupForm'].validate((valid) => {
        ...
        request({
          url: "/api/lowcode/rapid/downloadCode" ,
          method: "post",
          data : params
        }).then(res => {
          // 后台随机目录
          this.$alert('下载代码zip包', '生成成功', {
