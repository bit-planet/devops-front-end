        ...
        <template #default>
          <el-table :data="state.tableData.records" style="width: 100%"
            ...
            <el-table-column type="selection" width="55"/>
             ...
             <el-table-column prop="companyName" label="公司/组织" show-overflow-tooltip></el-table-column>
             <el-table-column prop="productName" label="产品/工程组" show-overflow-tooltip></el-table-column>
             <el-table-column prop="version" label="初始版本号" show-overflow-tooltip></el-table-column>
             <el-table-column prop="description" label="产品描述" show-overflow-tooltip></el-table-column>
...
<script setup lang="ts">
  ...
  const initTableData = () => {
    ...
    request({
      url: '/lowcode/initialconfig/productInfo/page',
      method: 'get',
      params: pageQuery,
    }).then(res => {
  ...
  const onRowDel = (row: Object) => {
    ...
    .then(() => {
      request({
        url: '/lowcode/initialconfig/productInfo/'+row.id,
        method: 'delete',
      }).then(res => {
