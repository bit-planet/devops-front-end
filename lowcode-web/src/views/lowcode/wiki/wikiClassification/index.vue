        ...
        <template #default>
          <el-table :data="state.tableData.records" style="width: 100%"
            ...
            <el-table-column type="selection" width="55"/>
             ...
             <el-table-column prop="classificationName" label="分类名" show-overflow-tooltip></el-table-column>
             <el-table-column prop="wikiSum" label="wiki数量" show-overflow-tooltip></el-table-column>
             <el-table-column prop="introduction" label="分类介绍" show-overflow-tooltip></el-table-column>
...
<script setup lang="ts">
  ...
  const onRowDel = (row: Object) => {
    ...
    .then(() => {
      request({
        url: '/lowcode/wiki/wikiClassification/'+row.id,
        method: 'delete',
      }).then(res => {
