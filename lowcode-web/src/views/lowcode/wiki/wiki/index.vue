        ...
        <template #default>
          <el-table :data="state.tableData.records" style="width: 100%"
            ...
            <el-table-column type="selection" width="55"/>
             ...
             <el-table-column prop="privacy" label="对谁可见" show-overflow-tooltip></el-table-column>
             <el-table-column prop="allowCoordination" label="允许协同" show-overflow-tooltip></el-table-column>
            ...
            <el-table-column label="操作" width="100">
              <template #default="scope">
                ...
                <el-button style="color: #67c23a" size="mini" type="text" @click="onGoToPage(scope.row.id)">去编辑</el-button>
              </template>
            </el-table-column>
          </el-table>
        </template>
