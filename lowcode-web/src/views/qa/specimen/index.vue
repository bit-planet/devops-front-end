        ...
        <template #default>
          <el-table :data="state.tableData.records" style="width: 100%"
            ...
            <el-table-column type="selection" width="55"/>
             ...
             <el-table-column prop="intentionId" label="意图ID" show-overflow-tooltip></el-table-column>
             <el-table-column prop="content" label="样本内容" show-overflow-tooltip></el-table-column>
